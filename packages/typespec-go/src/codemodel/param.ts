...
export type HeaderScalarType =
  | HeaderScalarPtrType
  | type.EncodedBytes
  | type.Ptr<HeaderScalarPtrType>;

export type HeaderScalarPtrType =
  | type.Constant
  | type.ETag
  | type.Literal
  | type.Scalar
...
export type HeaderScalarWireType =
  | type.EncodedBytes
  | HeaderScalarPtrType;
...
export type PathScalarParameterType =
  PathScalarParameterWireType | type.Ptr<PathScalarParameterPtrType>;

export type PathScalarParameterPtrType =
  type.Constant | type.Literal | type.Scalar | type.String | type.Time;

export type PathScalarParameterWireType =
  type.EncodedBytes | PathScalarParameterPtrType;
...
export type QueryScalarParameterType =
  QueryScalarParameterWireType | type.Ptr<QueryScalarParameterPtrType>;

export type QueryScalarParameterPtrType =
  type.Constant | type.Literal | type.Scalar | type.String | type.Time;

export type QueryScalarParameterWireType =
  type.EncodedBytes | QueryScalarParameterPtrType;
...
export type URIParameterType = URIParameterWireType | type.Ptr<URIParameterWireType>;

type URIParameterWireType = type.Constant | type.Scalar | type.String;
...
export function isHeaderParameter(param: MethodParameter): param is HeaderParameter {
  return (
    ...
    param.kind === "headerMapParam" ||
    param.kind === "headerScalarParam"
  );
}

/** narrows type to a HeaderScalarType within the conditional block */
export function isHeaderScalarType(type: Exclude<type.WireType, type.Ptr>): type is HeaderScalarWireType {
  switch (type.kind) {
    case "constant":
    case "encodedBytes":
    case "etag":
...
export function isPathScalarParameterType(type: type.WireType): type is PathScalarParameterWireType {
  switch (type.kind) {
    case "constant":
    case "encodedBytes":
    case "literal":
...
export function isQueryScalarParameterType(type: type.WireType): type is QueryScalarParameterWireType {
  switch (type.kind) {
    case "constant":
    case "encodedBytes":
    case "literal":
...
export function isURIParameterType(type: type.WireType): type is URIParameterWireType {
  switch (type.kind) {
    case "constant":
    case "scalar":
    case "string":
...
export class FormBodyCollectionParameter
  extends HttpParameterBase
  implements FormBodyCollectionParameter
{
  constructor(
    name: string,
    formDataName: string,
...
export class HeaderCollectionParameter
  extends HttpParameterBase
  implements HeaderCollectionParameter
{
  constructor(
    name: string,
    headerName: string,
...
export class MultipartFormBodyParameter
  extends HttpParameterBase
  implements MultipartFormBodyParameter
{
...
export class QueryCollectionParameter
  extends HttpParameterBase
  implements QueryCollectionParameter
{
  constructor(
    name: string,
    queryParam: string,
