...
import * as pkg from "./code-model.js";
...
export function newClientOptions(
  ...
  const options = new ClientOptions(pkg, optionsTypeName);
...
class HttpMethodBase
  extends method.Method<Client, result.ResponseEnvelope>
  implements HttpMethodBase
{
  constructor(
    name: string,
    client: Client,
...
export class ClientCredentialParameter
  extends method.Parameter
